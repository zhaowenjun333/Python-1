...
# 服务详情 中的 接口地址
MODEL_API_URL = "https://aip.baidubce.com/rpc/2.0/ai_custom/v1/detection/spider16"

# 调用 API 需要 ACCESS_TOKEN。若已有 ACCESS_TOKEN 则于下方填入该字符串
# 否则，留空 ACCESS_TOKEN，于下方填入 该模型部署的 API_KEY 以及 SECRET_KEY，会自动申请并显示新 ACCESS_TOKEN
ACCESS_TOKEN = ""
# AK和SK在应用列表里面都能看到
API_KEY = "dKP7q7uCDGjPGTHjxUkeLjAm"
SECRET_KEY = "jr4xQACvMYI1WCp3yFqAXHknhpR0GE4X"
