...
function result_name(s) {
    return base64.encode(urlencode(s))
}
...
function get_sp(rsaPubkey, servertime, nonce, password) {
...
password = RSAKey.encrypt(['1678112108', 'KPFM08'].join("\t") + "\n" + 'lry173022')
