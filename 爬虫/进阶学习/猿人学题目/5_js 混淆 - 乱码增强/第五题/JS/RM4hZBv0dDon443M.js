...
_0x4e96b4['_$pr'] = [
    "aa3934de0f1103d468136b7204380d80",
    "fecf0db89d4c5932d1dca0a87efb69ac",
    "a84863d168424c78ccb105a910f945a2",
    "be46943178919b19d81cf43f6de8778a",
]
...
// console.log(_0x4e96b4['_$qF'])

// 加密字符串(明文) keyStr: _0x4e96b4['_$pr']

// 出现值不一样时检查全局变量是否存在未定义的情况
// console.log(_0x4e96b4['_$tT'])
// console.log(_0x4e96b4['_$Jy'])
...
// function get_value() {
//     return [_0x4e96b4._$is, _0x474032(_$yw), _0x29dd83['toString'](), Date.parse(new Date()).toString()]
// }
//
