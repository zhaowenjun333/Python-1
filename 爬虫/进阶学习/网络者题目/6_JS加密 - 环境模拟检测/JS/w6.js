...
\t    <link rel="shortcut icon" href="/static/images/logo.jpg" type="image/jpeg">
        ...
        <script>
            ...
            if(user_agent.indexOf("Chrome") == -1){
                alert("兼容性差，如果没有数据显示请使用谷歌（Chrome）浏览器访问本页面");
            }
        </script>
        
    <script type="text/javascript" src="/static/js/6.js"></script>
    <style type="text/css">
        .content{
            margin: 0 auto;
            padding-top: 30px;
