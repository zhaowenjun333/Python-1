...
class AAEncodeSpider:
    def __init__(self):
        self.url = 'https://www.wangluozhe.com/challenge/3'
        self.api_url = 'https://www.wangluozhe.com/challenge/api/3'
        self.headers = {
...
if __name__ == '__main__':
    aaencode = AAEncodeSpider()
    # jjencode.run()
    t = timeit.timeit(stmt=aaencode.run, number=1)
    print(t)
