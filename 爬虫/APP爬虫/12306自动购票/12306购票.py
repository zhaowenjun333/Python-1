...
class APP12306:
    ...
    def parse_ticket(self):
        ...
        #     EC.presence_of_element_located((By.XPATH, '	/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[2]/android.view.View[1]'))
        # ).size
        # print(f'滑动距离{height["height"]}')# /hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View/android.view.View[2]/android.view.View[1]/android.view.View[17]
            ...
            for ticket_info in ticket:
                try:
                    if ticket_info == ticket_lst[i]:
                        # 车次
                        print(111)
                        train_num = ticket_info.find_element(By.XPATH, '//android.widget.TextView')
                        item['train_num'] = train_num.text
                        print('aaaa', item['train_num'])
                        # print(f'下标：{train_num.get_attribute("index")}')

                        # 起始时间
                        start = ticket_info.find_element(By.XPATH, '//android.view.View')
                        end = ticket_info.find_element(By.XPATH, '//android.widget.TextView')
                        train_time = start.text + '-' + end.text.replace("\xa0", "")
                        item['train_time'] = f'{train_time}'

                        # 车程时长
                        pass_time = ticket_info.find_element(By.XPATH, '//android.view.View')
        ...
        if self.num <= 2:
            ...
            self.driver.swipe(self.width * 0.5, self.height * 0.6, self.width * 0.5, self.height * 0.02, 1000)
            print('滑动成功')
            # 滑动完之后 继续解析
            time.sleep(2)
            self.parse_ticket()
